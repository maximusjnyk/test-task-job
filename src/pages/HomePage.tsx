...
export const HomePage: FC = () => {
  ...
  const [fetchRepos, { isLoading: areLoadingRepos, data: repos }] = useLazyGetUserRepoQuery()
      ...
      <div className='relative w-[560px]'>
        ...
        { dropdown && (
          <ul
            ...
            { data?.map(user => (
              <li
                className='py2 px-4 hover:bg-gray-500 hover:text-white transition-colors cursor-pointer'
                key={ user.id }
        ...
        <div className="container">
          { areLoadingRepos && <p className='text-center'>Repos are loading...</p> }
